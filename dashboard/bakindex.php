...
if (isset($_SESSION['user_id'])) {
  ...
  $query = "SELECT name FROM teachers WHERE id_teacher = '$userId'";
  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="index.php" class="brand-logo">
        ...
        <div class="brand-title">
          <h2 class="">MADU ADMIN</h2>
          <span class="brand-sub-title">Welcome, <?php echo $userName; ?></span>
        </div>
      </a>
    ...
    <div class="dlabnav">
      <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li>
            ...
            <ul aria-expanded="false">
              ...
              <li><a href="0template.php">Empty Page</a></li>
            </ul>
          </li>
        </ul>
        ...
        <div class="copyright">
          <p><strong>MADU Admin</strong> © 2023 All Rights Reserved</p>
          <p class="fs-12">
                    ...
                    <div class="card tryal-gradient">
                      <div class="card-body tryal row">
                        <div class="col-xl-7 col-sm-6">
                          ...
                          <span>Let Fillow manage your project automatically with
                            our best AI systems
                          </span>
                          ...
                          <div class="card-body d-flex px-4 justify-content-between">
                            <div>
                              <div class="">
                                ...
                                <span class="d-block fs-16 font-w400"><small class="text-danger">-2%</small> than
                                  last month</span>
                              </div>
                            </div>
                          ...
                          <div class="col-xl-6 col-sm-6">
                            <div class="owl-carousel card-slider">
                              <div class="items">
                                ...
                                <span class="fs-14 font-w400">Sed ut perspiciatis unde omnis iste natus
